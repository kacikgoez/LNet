...
def main(url, screenshot_path):
    ...
    #plotvis = vis(screenshot_path, pred_boxes, logo_conf)
    plotvis = None
    print("plot")
    ...
    url = "https://remove-this-later.com"

    ######################## Step2: Siamese (logo matcher) ########################################
    pred_target, matched_coord, siamese_conf = phishpedia_classifier_logo(pca, logo_boxes=pred_boxes,
